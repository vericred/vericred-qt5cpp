...
/*
 * SWGProviderGeocode.h
 * 
 * 
 */

#ifndef SWGProviderGeocode_H_
#define SWGProviderGeocode_H_
...
class SWGProviderGeocode: public SWGObject {
public:
    SWGProviderGeocode();
    SWGProviderGeocode(QString* json);
    virtual ~SWGProviderGeocode();
    void init();
    void cleanup();
    ...
    SWGProviderGeocode* fromJson(QString &jsonString);
