...
QString*
SWGPlanSearchResult::getPremiumSource() {
    return premium_source;
}
void
SWGPlanSearchResult::setPremiumSource(QString* premium_source) {
...
QString*
SWGPlanSearchResult::getSource() {
    return source;
}
void
SWGPlanSearchResult::setSource(QString* source) {
    this->source = source;
}
