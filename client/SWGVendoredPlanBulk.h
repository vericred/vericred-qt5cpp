...
/*
 * SWGVendoredPlanBulk.h
 * 
 * 
 */

#ifndef SWGVendoredPlanBulk_H_
#define SWGVendoredPlanBulk_H_
...
class SWGVendoredPlanBulk: public SWGObject {
public:
    SWGVendoredPlanBulk();
    SWGVendoredPlanBulk(QString* json);
    virtual ~SWGVendoredPlanBulk();
    void init();
    void cleanup();
    ...
    SWGVendoredPlanBulk* fromJson(QString &jsonString);
...
QString* getVendorId();
    void setVendorId(QString* vendor_id);
