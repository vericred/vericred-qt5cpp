...
/*
 * SWGPlanSearchResponseMeta.h
 * 
 * 
 */

#ifndef SWGPlanSearchResponseMeta_H_
#define SWGPlanSearchResponseMeta_H_
...
class SWGPlanSearchResponseMeta: public SWGObject {
public:
    SWGPlanSearchResponseMeta();
    SWGPlanSearchResponseMeta(QString* json);
    virtual ~SWGPlanSearchResponseMeta();
    void init();
    void cleanup();
    ...
    SWGPlanSearchResponseMeta* fromJson(QString &jsonString);

    qint32 getTotal();
    void setTotal(qint32 total);
bool getEligibleForChipMedicaid();
    void setEligibleForChipMedicaid(bool eligible_for_chip_medicaid);

private:
    qint32 total;
bool eligible_for_chip_medicaid;
};

} /* namespace Swagger */

#endif /* SWGPlanSearchResponseMeta_H_ */
