...
setValue(&child, pJson["child"], "bool", "");
...
obj->insert("child", QJsonValue(child));
...
bool
SWGRequestPlanFindApplicant::getChild() {
    return child;
}
void
SWGRequestPlanFindApplicant::setChild(bool child) {
    this->child = child;
}

bool
SWGRequestPlanFindApplicant::getSmoker() {
    return smoker;
}
void
SWGRequestPlanFindApplicant::setSmoker(bool smoker) {
    this->smoker = smoker;
}
