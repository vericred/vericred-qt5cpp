...
public:
    ...
    void searchNetworkSizes(SWGStateNetworkSizeRequest body);
    
private:
    void listStateNetworkSizesCallback (HttpRequestWorker * worker);
    void searchNetworkSizesCallback (HttpRequestWorker * worker);
    
signals:
    void listStateNetworkSizesSignal(SWGStateNetworkSizeResponse* summary);
    void searchNetworkSizesSignal(SWGStateNetworkSizeResponse* summary);
