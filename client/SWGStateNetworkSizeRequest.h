...
/*
 * SWGStateNetworkSizeRequest.h
 * 
 * 
 */

#ifndef SWGStateNetworkSizeRequest_H_
#define SWGStateNetworkSizeRequest_H_
...
class SWGStateNetworkSizeRequest: public SWGObject {
public:
    SWGStateNetworkSizeRequest();
    SWGStateNetworkSizeRequest(QString* json);
    virtual ~SWGStateNetworkSizeRequest();
    void init();
    void cleanup();
    ...
    SWGStateNetworkSizeRequest* fromJson(QString &jsonString);

    QList<qint32>* getNetworkIds();
    void setNetworkIds(QList<qint32>* network_ids);
QList<QString*>* getStateIds();
    void setStateIds(QList<QString*>* state_ids);

private:
    QList<qint32>* network_ids;
QList<QString*>* state_ids;
};

} /* namespace Swagger */

#endif /* SWGStateNetworkSizeRequest_H_ */
