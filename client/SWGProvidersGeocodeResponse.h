...
/*
 * SWGProvidersGeocodeResponse.h
 * 
 * 
 */

#ifndef SWGProvidersGeocodeResponse_H_
#define SWGProvidersGeocodeResponse_H_
...
class SWGProvidersGeocodeResponse: public SWGObject {
public:
    SWGProvidersGeocodeResponse();
    SWGProvidersGeocodeResponse(QString* json);
    virtual ~SWGProvidersGeocodeResponse();
    void init();
    void cleanup();
    ...
    SWGProvidersGeocodeResponse* fromJson(QString &jsonString);
...
#endif /* SWGProvidersGeocodeResponse_H_ */
