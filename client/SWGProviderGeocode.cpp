...
SWGProviderGeocode::SWGProviderGeocode(QString* json) {
    init();
    this->fromJson(*json);
}

SWGProviderGeocode::SWGProviderGeocode() {
    init();
}
...
SWGProviderGeocode*
SWGProviderGeocode::fromJson(QString &json) {
...
void
SWGProviderGeocode::fromJsonObject(QJsonObject &pJson) {
...
QJsonObject*
SWGProviderGeocode::asJsonObject() {
...
qint32
SWGProviderGeocode::getId() {
    return id;
}
void
SWGProviderGeocode::setId(qint32 id) {
    this->id = id;
}

SWGNumber*
SWGProviderGeocode::getLatitude() {
    return latitude;
}
void
SWGProviderGeocode::setLatitude(SWGNumber* latitude) {
    this->latitude = latitude;
}

SWGNumber*
SWGProviderGeocode::getLongitude() {
    return longitude;
}
void
SWGProviderGeocode::setLongitude(SWGNumber* longitude) {
