...
/*
 * SWGFormularyResponse.h
 * 
 * 
 */

#ifndef SWGFormularyResponse_H_
#define SWGFormularyResponse_H_
...
class SWGFormularyResponse: public SWGObject {
public:
    SWGFormularyResponse();
    SWGFormularyResponse(QString* json);
    virtual ~SWGFormularyResponse();
    void init();
    void cleanup();
    ...
    SWGFormularyResponse* fromJson(QString &jsonString);

    SWGMeta* getMeta();
    void setMeta(SWGMeta* meta);
QList<SWGFormulary*>* getFormularies();
    void setFormularies(QList<SWGFormulary*>* formularies);

private:
    SWGMeta* meta;
QList<SWGFormulary*>* formularies;
};

} /* namespace Swagger */

#endif /* SWGFormularyResponse_H_ */
