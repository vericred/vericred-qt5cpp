...
public:
    ...
    void showZipCounty(qint32 id);
    
private:
    void getZipCountiesCallback (HttpRequestWorker * worker);
    void showZipCountyCallback (HttpRequestWorker * worker);
    
signals:
    void getZipCountiesSignal(SWGZipCountiesResponse* summary);
    void showZipCountySignal(SWGZipCountyResponse* summary);
