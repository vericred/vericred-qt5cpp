...
SWGProvidersGeocodeResponse::SWGProvidersGeocodeResponse(QString* json) {
    init();
    this->fromJson(*json);
}

SWGProvidersGeocodeResponse::SWGProvidersGeocodeResponse() {
    init();
}
...
void
SWGProvidersGeocodeResponse::init() {
    meta = new SWGMeta();
providers = new QList<SWGProvider*>();
}

void
SWGProvidersGeocodeResponse::cleanup() {
    if(meta != NULL) {
        delete meta;
    }
if(providers != NULL) {
...
SWGProvidersGeocodeResponse*
SWGProvidersGeocodeResponse::fromJson(QString &json) {
...
void
SWGProvidersGeocodeResponse::fromJsonObject(QJsonObject &pJson) {
    setValue(&meta, pJson["meta"], "SWGMeta", "SWGMeta");
setValue(&providers, pJson["providers"], "QList", "SWGProvider");
}

QString
SWGProvidersGeocodeResponse::asJson ()
{
...
QJsonObject*
SWGProvidersGeocodeResponse::asJsonObject() {
...
SWGMeta*
SWGProvidersGeocodeResponse::getMeta() {
    return meta;
}
void
SWGProvidersGeocodeResponse::setMeta(SWGMeta* meta) {
    this->meta = meta;
}

QList<SWGProvider*>*
SWGProvidersGeocodeResponse::getProviders() {
    return providers;
}
void
SWGProvidersGeocodeResponse::setProviders(QList<SWGProvider*>* providers) {
